...
final class Slug_Handler implements Gedmo_Annotation
{
     ...
     */
    public function __construct(array $data = [], string $class = '', array $options = [])
    {
        if ([] !== $data) {
            ...
            $this->options = $this->get_attribute_value($data, 'options', $args, 2, $options);
            return;
        }
        $this->class = $class;
