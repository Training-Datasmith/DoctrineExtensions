...
final class Tree_Root implements Gedmo_Annotation
{
     ...
     */
    public function __construct(array $data = [], ?string $identifier_method = null)
    {
        if ([] !== $data) {
            ...
            $args = func_get_args();
            $this->identifier_method = $this->get_attribute_value($data, 'identifierMethod', $args, 1, $identifier_method);
            return;
        }
