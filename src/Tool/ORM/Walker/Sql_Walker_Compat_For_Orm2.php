 ...
 * @internal
 */
trait Sql_Walker_Compat_For_Orm2
{
    /**
     ...
     */
    public function get_executor($statement)
    {
     ...
     */
    public function get_finalizer($AST): Sql_Finalizer
    {
     ...
     * @return string
     */
    public function walk_select_clause($select_clause)
    {
     ...
     * @return string
     */
    public function walk_from_clause($from_clause)
    {
     ...
     * @return string
     */
    public function walk_order_by_clause($order_by_clause)
    {
     ...
     * @return string
     */
    public function walk_having_clause($having_clause)
    {
     ...
     * @return string
     */
    public function walk_subselect_from_clause($subselect_from_clause)
    {
     ...
     * @return string
     */
    public function walk_simple_select_clause($simple_select_clause)
    {
     ...
     * @return string
     */
    public function walk_group_by_clause($group_by_clause)
    {
     ...
     * @return string
     */
    public function walk_delete_clause($delete_clause)
    {
     ...
     * @return string
     */
    public function walk_where_clause($where_clause)
    {
